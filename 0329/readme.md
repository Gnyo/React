...
- 아래의 코드들 세 개 모두 같은 결과를 출력하는 코드임

![image](https://github.com/Gnyo/React/assets/102850495/971c12e4-ad59-4d5b-9394-49c6696aa5a8) | ![image](https://github.com/Gnyo/React/assets/102850495/cad02242-077d-4524-8554-d46712b0ac66) | ![image](https://github.com/Gnyo/React/assets/102850495/eda025a3-ac65-4ad0-b606-423b81352578)
---| ---| ---
...
- JSX 코드는 Babel과 같은 트랜스파일러(transfiler)를 통해 브라우저가 실행할 수 있는 형태의 자바스크립트로 변환
...
- Virtual DOM에서 컴포넌트 변화를 감지할 때 효율적으로 비교할 수 있도록 컴포넌트 내부는 하나의 DOM 트리 구조로 이루어져야 한다는 규칙이 있음 
...
- class 대신 className
  ...
  + JSX에서 class는 className이 되고 tabindex는 tabIndex가 됨
...
### JSX Code 작성 실습
- 터미널에서 아래의 명령어를 입력하여 'book'이라는 리액트 프로젝트 생성
  ```
  npx create-react-app book
  ```

book/src/jsxCode/book.js에 아래의 코드 작성 | book/src/jsxCode/book.js에 아래의 코드 작성 | book/src/index.js를 아래와 같이 수정
---| ---| ---
![image](https://github.com/Gnyo/React/assets/102850495/22566617-b9c8-4880-a95f-95fbbef66262) | ![image](https://github.com/Gnyo/React/assets/102850495/c1af0b98-8a62-4bd9-a97c-971697d86cbf) | ![image](https://github.com/Gnyo/React/assets/102850495/20aa7e1a-a570-45ff-a8e4-f58ed7ffbd81)
...
![image](https://github.com/Gnyo/React/assets/102850495/12da1604-d2f0-4b71-9f15-2e8115418991) | ![image](https://github.com/Gnyo/React/assets/102850495/fd2b0772-318f-4e98-9a01-ebfe25e19a66)
---|--- 
...
- 결과
    ![image](https://github.com/Gnyo/React/assets/102850495/663c266e-212c-419b-a81c-86b160a24433) | ![image](https://github.com/Gnyo/React/assets/102850495/e6a03429-b3cf-4b70-9abf-5cbb52fa127a)
    ---| ---
...
- 결과
    ![image](https://github.com/Gnyo/React/assets/102850495/10cfd350-e30d-4191-ab5d-5276d63336f0)
    ---|
...
- 코드
  ...
  + ※3 부분에서 앞의 코드에서 화면에 DOM을 변경
    ![image](https://github.com/Gnyo/React/assets/102850495/e9114110-01a8-41be-8a43-3d962d8d9f0f) | ![image](https://github.com/Gnyo/React/assets/102850495/5af1fd66-6c68-4f95-aae5-1b29a07deda0)
    ---|---
